...
{/* price markup info removed */}
              ...
              {connected ? (
                <a
                  ...
                  className="w-full px-6 py-3.5 bg-gold-500 hover:bg-gold-600 text-dark-900 rounded-lg text-base font-semibold transition-colors duration-200 text-center block"
                >
                  Buy on Magic Eden
                </a>
              ) : (
