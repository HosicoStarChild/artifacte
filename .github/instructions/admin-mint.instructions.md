...
applyTo:
  - "app/admin/_components/mint-form-content.tsx"
  - "app/admin/page.tsx"
...
- Use `../../app/admin/_components/mint-form-content.tsx` and `../../lib/nft-metadata.ts` as the implementation source of truth. The detailed walkthrough lives in [../../docs/ADMIN_MINT_PROCESS.md](../../docs/ADMIN_MINT_PROCESS.md).
...
- When docs and code diverge, keep the code aligned with `../../app/admin/_components/mint-form-content.tsx` and `../../lib/nft-metadata.ts`, then update the linked docs if the task requires documentation changes.
