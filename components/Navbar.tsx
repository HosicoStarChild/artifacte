      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            {isAdmin && (
              <Link href="/admin/applications" className="text-sm text-gold-400 hover:text-gold-300 transition font-medium">Admin</Link>
            )}
        ...
        {menuOpen && (
          <div className="md:hidden pb-4 space-y-3">
            ...
            {isAdmin && (
              <Link href="/admin/applications" className="block text-sm text-gold-400 hover:text-gold-300 font-medium" onClick={() => setMenuOpen(false)}>Admin</Link>
            )}
